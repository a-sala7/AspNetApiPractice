        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description_Ar = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: true),
                    Description_En = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserProduct", x => new { x.UsersId, x.WishlistId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserProduct_Products_WishlistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishlistsProducts", x => new { x.UserId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserProduct_WishlistId",
